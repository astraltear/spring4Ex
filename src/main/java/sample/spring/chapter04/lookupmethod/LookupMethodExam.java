...
public class LookupMethodExam {
	
	private static Logger logger = Logger.getLogger(LookupMethodExam.class);
	
	public static void main(String[] args) {
		ApplicationContext context = new ClassPathXmlApplicationContext("classpath:applicationContext_chapter04_lookupmethod.xml");
